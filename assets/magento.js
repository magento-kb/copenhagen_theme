   ...
   $("label[for=request_issue_type_select]").text("Please select the Magento Product for which you are seeking Support:");
    ...
    $("#request_custom_fields_"+ magento_version_field_id).change(function (){
        ...
        var unsupported_list = [ "v1_14_4_3","v1_14_4_2","v1_14_4_1","v1_14_4_0","v1_14_3_10","v1_14_3_9","v1_14_3_8","v1_14_3_7","v1_14_3_6","v1_14_3_4","v1_14_3_3","v1_14_3_2","v1_14_3_1","v1_14_3_0","v1_14_2_4","v1_14_2_3","v1_14_2_2","v1_14_2_1","v1_14_2_0","v1_14_1_0","v1_14_0_1","v1_14_0_0","v1_13_1_0","v1_13_0_3","v1_13_0_2","v1_13_0_1","v1_13_0_0",
                                ...
                                "v2_3_0_unsupported", "v2_3_1_unsupported", "v2_3_2_unsupported", "v2_3_2-p1_unsupported", "v2_3_2-p2_unsupported", "v2_3_3_unsupported", "v2_3_3-p1_unsupported", "v2_3_4_unsupported", "v2_3_4-p1_unsupported", "v2_3_4-p2_unsupported", "v2_3_5_unsupported", "v2_3_5-p1_unsupported", "v2_3_5-p2_unsupported", "v2_3_6_unsupported", "v2_3_6-p1_unsupported"];
        var extended_support_list = ["v2_3_7_unsupported", "v2_3_7-p1_unsupported", "v2_3_7-p2_unsupported", "v2_3_7-p3_unsupported", "v2_3_7-p4_unsupported"]
        
        if (unsupported_list.includes($(this).val())) {
          window.alert("This version of Adobe Commerce is no longer supported. Please consider upgrading.");
        } 
        // SWAT-1015 : 2.3.7 Extended Support - Overhaul Out of Support Popup
        if (extended_support_list.includes($(this).val()) && !userEntitlement.includes("entitlement_2.3.7_extended_support")) {
            window.alert("Adobe Commerce 2.3.7 is no longer supported. If you are interested in purchasing Extended Support, please contact your Customer Success Manager. Otherwise please consider upgrading.");
        }
      });
